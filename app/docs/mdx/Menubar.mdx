...
Una barra de menús para aplicaciones. Combina `Menubar` de Base UI con `Menu.Root` y sus sub-componentes para crear menús desplegables con soporte completo de teclado.
