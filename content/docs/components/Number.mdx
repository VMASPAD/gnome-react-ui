---
title: Number Field
description: An input specifically designed for numbers, complete with increment/decrement steppers, scrub area support, and advanced formatting.
---

import ComponentPreview from "@/components/component-preview";

<ComponentPreview title="Number Field component" name="number">
