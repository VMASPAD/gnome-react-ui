---
title: Progress
description: A component that displays an indicator showing the completion progress of a task, typically displayed as a progress bar.
---

import ComponentPreview from "@/components/component-preview";

<ComponentPreview title="Progress component" name="progress">
