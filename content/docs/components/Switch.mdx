---
title: Switch
description: A control that allows the user to toggle between checked and not checked. It functions as an alternative to the Checkbox component.
---

import ComponentPreview from "@/components/component-preview";

<ComponentPreview title="Switch component" name="switch">
