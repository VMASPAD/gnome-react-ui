---
title: Combobox
description: A text input that provides a list of suggested options, allowing users to select an existing value or type a new one.
---

import ComponentPreview from "@/components/component-preview";


<ComponentPreview title="Combobox component" name="combobox">
